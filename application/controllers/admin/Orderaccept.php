...
class Orderaccept extends CI_Controller
{
    ...
    public function index()
    {
        ...
        {
            $this->session->unset_userdata('sess_search_orderaccept');
            $this->session->unset_userdata('sess_search_orderaccept2');
        ...
        $config                = array();
        $config["base_url"]    = base_url() . "paramedic/orderaccept/index/" . $limit;
        ...
        $data["transaction"]        	  = $this->model_transaction->order_accept();
        ...
        $this->load->view('admin/orderaccept', $data);
