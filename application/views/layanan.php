            ...
            <div class="page-content">
                <div class="page-inner"><br><br>
                    <div class="page-title">
                        <h3 class="breadcrumb-header"><?php echo $layanan[0]->service_name; ?></h3>
                        <?php echo $layanan[0]->service_pricerange ?>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-white">
                                    <img src="<?php echo base_url()?>img/service/<?php echo $layanan[0]->service_image?>" height="200" width="200" >
                                    <p><?php echo $layanan[0]->service_desc?></p>
                                </div>
                            </div>
                        </div><!-- Row -->
                    </div><!-- Main Wrapper -->
