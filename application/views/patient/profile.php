    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                <li><a href="<?php echo base_url(); ?>patient"><i class="material-icons">home</i> Beranda</a></li>
        ...
        <div class="container-fluid">
            ...
            <?php 
                ...
                $datetime = new DateTime($user[0]->user_registerdate);
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php echo form_open_multipart('patient/profile/update'); ?>
                            <div class="row clearfix">
                                <div class="body">
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            <?php if($user[0]->user_image) { ?>
                                                <img style="width : 50%" class="center" src="<?php echo base_url('img/user/').$user[0]->user_image; ?>"> 
                                            <?php } else { ?>
                                                <?php if($user[0]->user_image == 'Laki-laki') { ?> 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="email" id="user_email" class="form-control" name="user_email" placeholder="Masukkan Alamat Email" value="<?php echo $user[0]->user_email; ?>">
                                                    <input type="hidden" class="form-control" name="user_id" value="<?php echo $user[0]->user_id; ?>">
                                                    <input type="hidden" class="form-control" name="user_password_old" value="<?php echo $user[0]->user_password; ?>">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control show-tick" id="district_id" name="district_id">
                                                ...
                                                <?php foreach ($district as $key) { ?>
                                                    <option value="<?php echo $key->district_id;?>" <?php if($user[0]->district_id == $key->district_id) echo 'selected'; ?>><?php echo $key->district_name; ?></option>
                                                <?php }; ?>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="user_name" class="form-control" name="user_name" placeholder="Masukkan Nama Lengkap" value="<?php echo $user[0]->user_name; ?>" autofocus>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="user_datebirth" class="datepicker form-control" name="user_datebirth" placeholder="Masukkan Tanggal Lahir" value="<?php echo $user[0]->user_datebirth; ?>">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="user_phone" class="form-control" name="user_phone" placeholder="Masukkan Nomor Handphone" value="<?php echo $user[0]->user_phone; ?>">
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <textarea rows="4" class="form-control no-resize" name="user_address" placeholder="Masukkan Alamat Lengkap"><?php echo $user[0]->user_address; ?></textarea>
                                                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php echo form_open_multipart('admin/patient/change_password'); ?>
                            <div class="row clearfix">
                                <div class="body">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <input type="hidden" class="form-control" name="user_id" value="<?php echo $user[0]->user_id; ?>">
                                                    <input type="hidden" class="form-control" name="user_name" value="<?php echo $user[0]->user_name; ?>">
                                                </div>
