    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">playlist_add_check</i> Paket</li>
            </ol>
                <?php      
                    ...
                    <div class="card">
                        <div class="header bg-green">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/package/insert_view" title="Tambah Paket">
                                        <i class="material-icons">add</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/package" title="Refresh">
                                        <i class="material-icons">refresh</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/package/export" title="Download File">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("admin/package/result");?>
                                            <div class="col-md-3">
                                                <select class="form-control show-tick" name="column_name">
                                                    ...
                                                    <?php
                                                        foreach ($column as $c) 
                                                        {
                                                            ...
                                                            if($c->COLUMN_NAME==$this->session->userdata('sess_search_package2'))
                                                            {
                                                    ?>
                                            ...
                                            <div class="col-md-3">
                                                <?php if($this->session->userdata('sess_search_package')) { ?>
                                                        <input type="text" class="form-control" placeholder="Search..." name="key" value="<?php echo $this->session->userdata('sess_search_package')?>" />
                                                <?php   } 
                                                        else
                                                        {    
                                                ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->package_desc; ?></td>
                                            <td><?php echo $key->service_name; ?></td>
                                            <td>Rp. <?php echo number_format($key->package_price); ?></td>
                                            <td>
                                                <button class="btn btn-white btn-info btn-bold btn-md" onclick="window.location.href='<?php echo base_url();?>admin/package/update_view?package_id=<?php echo base64_encode($id); ?>'" title="Edit Data">
                                         ...
                                         <div class="modal fade" id="deleteModal<?php echo $id;?>" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <?php echo form_open("admin/package/delete");?>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger">
                                                                ...
                                                                "<b><?php echo $key->package_name?></b>" 
                                                                ?
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->package_id?>" name="package_id" required="required">
                                                            <input type="hidden" class="form-control"  value='<?php echo $key->package_image; ?>' name="package_image" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->package_name?>" name="package_name" required="required">
                                    ...
                                    $.ajax({
                                        success:function()
                                        {
                                            <?php if($this->uri->segment(3)=='result') { ?>
                                                location.href='<?php echo base_url()?>admin/package/result/'+angka;    
                                            <?php } else { ?>
                                                location.href='<?php echo base_url()?>admin/package/index/'+angka;    
                                            <?php } ?> 
                                        }
                                    });
                                }
