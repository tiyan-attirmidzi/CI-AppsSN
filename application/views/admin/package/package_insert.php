    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">add</i> Tambah Paket</li>
            </ol>
            <?php      
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart('admin/package/input'); ?>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="package_name" class="form-control" name="package_name" placeholder="Masukkan Nama Paket" value="<?php echo set_value('package_name'); ?>" autofocus>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="package_price" class="form-control price" name="package_price" placeholder="Masukkan Tarif Paket" value="<?php echo set_value('package_price'); ?>">
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="package_desc" class="form-control" id="ckeditor2" cols="30" rows="20"><?php echo set_value('package_desc'); ?></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control show-tick" id="service_id" name="service_id">
                                            ...
                                            <?php foreach ($service as $key) { ?>
                                                <option value="<?php echo $key->service_id; ?>"><?php echo $key->service_name; ?></option>
                                            <?php }; ?>
                                        </select>
                                        <span class='text-danger'><?php echo form_error('service_id'); ?></span>
                                    </div>
                                    <div class="col-sm-12">
                                        <label for="package_image">Gambar</label>
