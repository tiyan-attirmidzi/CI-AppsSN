    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">burst_mode</i> Slider</li>
            </ol>
            <?php      
                    ...
                    <div class="card">
                        <div class="header bg-green">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/slider/insert_view" title="Tambah Slider">
                                        <i class="material-icons">add</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/slider" title="Refresh">
                                        <i class="material-icons">refresh</i>
                                    </a>
                                </li>
                                <!-- <li>
                                    <a href="<?php //echo base_url(); ?>admin/slider/export" title="Download File">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("admin/slider/result");?>
                                            <div class="col-md-3">
                                                <select class="form-control show-tick" name="column_name">
                                                    ...
                                                    <?php
                                                        foreach ($column as $c) 
                                                        {
                                                            ...
                                                            if($c->COLUMN_NAME==$this->session->userdata('sess_search_slider2'))
                                                            {
                                                    ?>
                                            ...
                                            <div class="col-md-3">
                                                <?php if($this->session->userdata('sess_search_slider')) { ?>
                                                        <input type="text" class="form-control" placeholder="Search..." name="key" value="<?php echo $this->session->userdata('sess_search_slider')?>" />
                                                <?php   } 
                                                        else
                                                        {    
                                                ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->slider_image; ?></td>
                                            <td>
                                                <?php            
                                                    if($key->slider_status == 1)
                                                    {
                                                        echo '  
                                            ...
                                            <td>
                                                <button class="btn btn-white btn-info btn-bold btn-md" onclick="window.location.href='<?php echo base_url();?>admin/slider/update_view?slider_id=<?php echo base64_encode($id); ?>'" title="Edit Data">
                                                    ...
                                                    <?php echo form_open("admin/slider/delete");?>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger">
                                                                ...
                                                                "<b><?php echo $key->slider_name?></b>" 
                                                                ?
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->slider_id?>" name="slider_id" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->slider_image?>" name="slider_image" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->slider_name?>" name="slider_name" required="required">
                                    ...
                                    $.ajax({
                                        success:function()
                                        {
                                            <?php if($this->uri->segment(3)=='result') { ?>
                                                location.href='<?php echo base_url()?>admin/slider/result/'+angka;    
                                            <?php } else { ?>
                                                location.href='<?php echo base_url()?>admin/slider/index/'+angka;    
                                            <?php } ?> 
                                        }
                                    });
                                }
