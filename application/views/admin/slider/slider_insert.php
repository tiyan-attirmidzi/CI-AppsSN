    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">add</i> Tambah Slider</li>
            </ol>
            <?php      
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart('admin/slider/input'); ?>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="slider_name" class="form-control" name="slider_name" placeholder="Masukkan Nama Slider" value="<?php echo set_value('slider_name'); ?>" autofocus>
                                            </div>
                                            <span class='text-danger'><?php echo form_error('slider_name'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <label for="slider_image">Gambar</label>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="slider_desc" class="form-control" id="ckeditor2" cols="30" rows="20"><?php echo set_value('slider_desc'); ?></textarea>
                                            </div>
