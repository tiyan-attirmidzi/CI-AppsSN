    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">mode_edit</i> Edit Layanan</li>
            </ol>
            <?php      
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart('admin/service/edit'); ?>
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="col-sm-12">
                                            <label for="service_name">ID Layanan</label>
                                            <span class='text-danger'> *</span>
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="service_id" class="form-control" name="service_id" value="<?php echo $keys[0]['service_id']; ?>" readonly>
                                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="service_name" class="form-control" name="service_name" placeholder="Masukkan Nama Layanan" value="<?php echo $keys[0]['service_name']; ?>" autofocus>
                                                </div>
                                                <span class='text-danger'><?php echo form_error('service_name'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <label for="service_image">Ganti Gambar</label>
                                    ...
                                    <div class="col-sm-6">
                                        <?php if($keys[0]['service_image']) { ?>
                                                <img src="<?php echo base_url(); ?>img/service/<?php echo $keys[0]['service_image']; ?>" class="img-resposive center" width="50%">
                                        <?php } else { ?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="service_desc" class="form-control" id="ckeditor2" cols="30" rows="20"><?php echo $keys[0]['service_desc']; ?></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="service_pricerange" class="form-control" id="ckeditor" cols="30" rows="20"><?php echo $keys[0]['service_pricerange']; ?></textarea>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="demo-radio-button">
                                            <?php 
                                                if ($keys[0]['service_status'] == "1") 
                                                {
                                                    echo "
                                                        <input name='service_status' type='radio' id='radio_1' value='1' class='with-gap radio-col-green' checked/>
                                                        <label for='radio_1'>Aktif</label>
                                                        <input name='service_status' type='radio' id='radio_2' value='0' class='with-gap radio-col-green' />
