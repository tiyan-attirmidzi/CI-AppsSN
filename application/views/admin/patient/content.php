    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">accessible</i> Pasien</li>
            </ol>
            <?php      
                    ...
                    <div class="card">
                        <div class="header bg-green">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/patient/insert" title="Tambah Pasien">
                                        <i class="material-icons">add</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/patient" title="Refresh">
                                        <i class="material-icons">refresh</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/patient/export" title="Download File">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("admin/patient/result");?>
                                            <div class="col-md-3">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $key->patient_noktp; ?></td>
                                            <td><?php echo $key->patient_name; ?></td>
                                            <td><?php echo $key->patient_sex; ?></td>
                                            <td><?php echo $key->patient_job; ?></td>
                                            <td><?php echo $key->patient_phone; ?></td>
                                            <td>
                                                <button class="btn btn-white btn-info btn-bold btn-md" onclick="window.location.href='<?php echo base_url();?>admin/patient/update_view?patient=<?php echo base64_encode($id); ?>'" title="Edit Data">
                                                ...
                                                <div class="modal-content">
                                                    <?php echo form_open("admin/patient/delete");?>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="hidden" class="form-control" value="<?php echo $key->patient_name?>" name="patient_name" required="required">
