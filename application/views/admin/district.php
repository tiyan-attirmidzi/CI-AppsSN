    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">location_on</i> Wilayah</li>
            </ol>
                <?php      
                    ...
                    <div class="card">
                        <div class="header bg-green">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="javascript:void(0);" data-target="#myModal" data-toggle="modal" title="Tambah Wilayah">
                                        <i class="material-icons">add</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/district" title="Refresh">
                                        <i class="material-icons">refresh</i>
                                    </a>
                                </li>
                                <!-- <li>
                                    <a href="<?php //echo base_url(); ?>admin/district/export" title="Download File">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"><b>Tambah Wilayah</b></h4>
                                            </div>
                                            <div class="modal-body">
                                                <?php echo form_open_multipart("admin/district/input");?>
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label>Nama Wilayah</label>
                                                            <span class="text-danger"> *</span>
                                                            <input type="text" class="form-control" placeholder="Masukkan Nama Wilayah" name="district_name" required="required" autofocus>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Deskripsi</label>
                                                            <span class="text-danger"> *</span>
                                                            <textarea class="form-control" name="district_desc" placeholder="Masukkan Deskripsi" rows="4" required="required"></textarea>
                                                        </div>
                                                    </div>                                
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("admin/district/result");?>
                                            <div class="col-md-3">
                                                <select class="form-control show-tick" name="column_name">
                                                    ...
                                                    <?php
                                                        foreach ($column as $c) 
                                                        {
                                                            ...
                                                            if($c->COLUMN_NAME==$this->session->userdata('sess_search_district2'))
                                                            {
                                                    ?>
                                            ...
                                            <div class="col-md-3">
                                                <?php if($this->session->userdata('sess_search_district')) { ?>
                                                        <input type="text" class="form-control" placeholder="Search..." name="key" value="<?php echo $this->session->userdata('sess_search_district')?>" />
                                                <?php   } 
                                                        else
                                                        {    
                                                ?>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        if (is_array($district) || is_object($district))
                                        {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->district_desc; ?></td>
                                            <td>
                                        ...
                                        <div class="modal fade" id="editModal<?php echo $id?>" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title"><b>Ubah Data Wilayah</b></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <?php echo form_open("admin/district/edit");?>
                                                            <div class="box-body">
                                                                    ...
                                                                    <div class="tab-content">
                                                                        <div class="tab-pane active">
                                                                            <div class="form-group alert-primery">
                                                                                <label>Nama</label>
                                                                                <span class="text-danger"> *</span>
                                                                                <input type="text" class="form-control"  value='<?php echo $key->district_name; ?>' name="district_name" required="required" placeholder="Nama Wilayah" autofocus>
                                                                                <input type="hidden" class="form-control"  value='<?php echo $key->district_id; ?>' name="district_id" required="required" readonly>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label>Deskripsi</label>
                                                                                <span class="text-danger"> *</span>
                                                                                <textarea class="form-control" name="district_desc" required="required" rows="4" placeholder="Deskripsi Wilayah"><?php echo $key->district_desc;?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- /.tab-content -->
                                        ...
                                        <!-- End Modal Edit -->
                                         ...
                                         <div class="modal fade" id="deleteModal<?php echo $id;?>" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <?php echo form_open("admin/district/delete");?>
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger">
                                                                ...
                                                                "<b><?php echo $key->district_name?></b>" 
                                                                ?
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->district_id?>" name="district_id" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->district_name?>" name="district_name" required="required">
                                    ...
                                    $.ajax({
                                        success:function()
                                        {
                                            <?php if($this->uri->segment(3)=='result') { ?>
                                                location.href='<?php echo base_url()?>admin/district/result/'+angka;    
                                            <?php } else { ?>
                                                location.href='<?php echo base_url()?>admin/district/index/'+angka;    
                                            <?php } ?> 
                                        }
                                    });
                                }
