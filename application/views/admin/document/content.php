    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">storage</i> Dokumen</li>
            </ol>
            <?php      
                    ...
                    <div class="card">
                        <div class="header bg-green">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/document/insert" title="Tambah Dokumen">
                                        <i class="material-icons">add</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/document" title="Refresh">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("admin/document/result");?>
                                            <div class="col-md-3">
                                                <select class="form-control show-tick" name="column_name">
                                                    ...
                                                    <?php
                                                        foreach ($column as $c) 
                                                        {
                                                            ...
                                                            if($c->COLUMN_NAME==$this->session->userdata('sess_search_document2'))
                                                            {
                                                    ?>
                                            ...
                                            <div class="col-md-3">
                                                <?php if($this->session->userdata('sess_search_document')) { ?>
                                                        <input type="text" class="form-control" placeholder="Search..." name="key" value="<?php echo $this->session->userdata('sess_search_document')?>" />
                                                <?php   } 
                                                        else
                                                        {    
                                                ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->document_desc; ?></td>
                                            <td><?php echo $key->document_file; ?></td>
                                            <td>
                                                <?php            
                                                    if($key->document_status == 1)
                                                    {
                                                        echo '  
                                            ...
                                            <td>
                                                <button class="btn btn-white btn-info btn-bold btn-md" onclick="window.location.href='<?php echo base_url();?>admin/document/update_view?document_id=<?php echo base64_encode($id); ?>'" title="Edit Data">
                                                    ...
                                                    <?php echo form_open("admin/document/delete");?>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger">
                                                                ...
                                                                "<b><?php echo $key->document_name?></b>" 
                                                                ?
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->document_id?>" name="document_id" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->document_name?>" name="document_name" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->document_file?>" name="document_file" required="required">
                                    ...
                                    $.ajax({
                                        success:function()
                                        {
                                            <?php if($this->uri->segment(3)=='result') { ?>
                                                location.href='<?php echo base_url()?>admin/document/result/'+angka;    
                                            <?php } else { ?>
                                                location.href='<?php echo base_url()?>admin/document/index/'+angka;    
                                            <?php } ?> 
                                        }
                                    });
                                }
