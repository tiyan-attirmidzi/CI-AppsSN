        ...
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">subject</i> Post Blog</li>
            </ol>
            <?php      
                    ...
                    <div class="card">
                        <div class="header bg-green">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/post/insert_view" title="Tambah Blog">
                                        <i class="material-icons">add</i>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/post" title="Refresh">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("admin/post/result");?>
                                            <div class="col-md-3">
                                                <select class="form-control show-tick" name="column_name">
                                                    ...
                                                    <?php
                                                        foreach ($column as $c) 
                                                        {
                                                            ...
                                                            if($c->COLUMN_NAME==$this->session->userdata('sess_search_post2'))
                                                            {
                                                    ?>
                                            ...
                                            <div class="col-md-3">
                                                <?php if($this->session->userdata('sess_search_post')) { ?>
                                                        <input type="text" class="form-control" placeholder="Search..." name="key" value="<?php echo $this->session->userdata('sess_search_post')?>" />
                                                <?php   } 
                                                        else
                                                        {    
                                                ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $key->post_slug; ?></td>
                                            <td><?php echo $key->post_postby; ?></td>
                                            <td><?php echo $key->post_postdate; ?></td>
                                            <td>
                                                <?php            
                                            ...
                                            <td>
                                                <button class="btn btn-white btn-info btn-bold btn-md" onclick="window.location.href='<?php echo base_url();?>admin/post/update_view?post_id=<?php echo base64_encode($id); ?>'" title="Edit Data">
                                                    ...
                                                    <?php echo form_open("admin/post/delete");?>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-danger">
                                                                ...
                                                                "<b><?php echo $key->post_name?></b>" 
                                                                ?
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->post_id?>" name="post_id" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->post_image?>" name="post_image" required="required">
                                                            <input type="hidden" class="form-control" value="<?php echo $key->post_name?>" name="post_name" required="required">
                                    ...
                                    $.ajax({
                                        success:function()
                                        {
                                            <?php if($this->uri->segment(3)=='result') { ?>
                                                location.href='<?php echo base_url()?>admin/post/result/'+angka;    
                                            <?php } else { ?>
                                                location.href='<?php echo base_url()?>admin/post/index/'+angka;    
                                            <?php } ?> 
                                        }
                                    });
                                }
