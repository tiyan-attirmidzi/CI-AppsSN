        ...
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-green">
                ...
                <li class="active"><i class="material-icons">mode_edit</i> Edit Blog</li>
            </ol>
            <?php      
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart('admin/post/edit'); ?>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <img src="<?php echo base_url(); ?>img/post/<?php echo $keys[0]['post_image']; ?>" class="img-resposive center" width="50%">     
                                        <label for="post_title">Judul Blog</label>
                                        <span class='text-danger'> *</span>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="post_title" class="form-control" name="post_title" placeholder="Masukkan Judul Blog" value="<?php echo $keys[0]['post_title']; ?>" autofocus>
                                                <input type="hidden" id="post_id" class="form-control" name="post_id" value="<?php echo $keys[0]['post_id']; ?>" autofocus>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control show-tick" id="postcategory_id" name="postcategory_id">
                                            ...
                                            <?php foreach ($postcategory as $key) { ?>
                                                <option value="<?php echo $key->postcategory_id; ?>" <?php if($keys[0]['postcategory_id'] == $key->postcategory_id) echo 'selected'; ?> ><?php echo $key->postcategory_name; ?></option>
                                            <?php }; ?>
                                        </select>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="post_postby" class="form-control" name="post_postby" placeholder="Di Post Oleh" value="<?php echo $keys[0]['post_postby']; ?>" autofocus>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="post_desc" class="form-control" id="ckeditor2" cols="30" rows="20"><?php echo $keys[0]['post_desc']; ?></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="demo-radio-button">
                                            <?php 
                                                if ($keys[0]['post_status'] == "1") 
                                                {
                                                    echo "
                                                        <input name='post_status' type='radio' id='radio_1' value='1' class='with-gap radio-col-green' checked/>
                                                ...
                                                else
                                                {
                                                    echo "
                                                        ...
                                                        <label for='radio_1'>Aktif</label>
                                                        <input name='post_status' type='radio' id='radio_2' value='0' class='with-gap radio-col-green' checked/>
                                                        <label for='radio_2'>Non Aktif</label>
                                                    ";
                                                }
                                            ?>
