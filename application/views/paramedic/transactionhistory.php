                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <?php echo form_open("paramedic/history/result");?>
                                            <div class="col-md-3">
                                                <select class="form-control show-tick" name="column_name">
                                                    ...
                                                    <?php
                                                        foreach ($column as $c) 
                                                        {
                                                            ...
                                                            if($c->COLUMN_NAME==$this->session->userdata('sess_search_history2'))
                                                            {
                                                    ?>
                                            ...
                                            <div class="col-md-3">
                                                <?php if($this->session->userdata('sess_search_history')) { ?>
                                                        <input type="text" class="form-control" placeholder="Search..." name="key" value="<?php echo $this->session->userdata('sess_search_history')?>" />
                                                <?php   } 
                                                        else
                                                        {    
                                                ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-white btn-info btn-bold btn-md" onclick="window.location.href='<?php echo base_url();?>paramedic/history/detail_view?transaction_id=<?php echo $id?>'">
                                    ...
                                    $.ajax({
                                        success:function()
                                        {
                                            <?php if($this->uri->segment(3)=='result') { ?>
                                                location.href='<?php echo base_url()?>paramedic/history/result/'+angka;    
                                            <?php } else { ?>
                                                location.href='<?php echo base_url()?>paramedic/history/index/'+angka;    
                                            <?php } ?> 
                                        }
                                    });
                                }
